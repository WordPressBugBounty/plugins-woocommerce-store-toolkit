...
[Wholesale Suite](https://wordpress.org/plugins/woocommerce-wholesale-prices/) – The #1 rated and easiest way to add wholesale features to your WooCommerce store.
[Advanced Coupons](https://wordpress.org/plugins/advanced-coupons-for-woocommerce-free/) – add loads of new advanced coupon features to WooCommerce including BOGO coupons, store credit, coupon rules, and more.
[WC Vendors](https://wordpress.org/plugins/wc-vendors/) – turn your WooCommerce store into a multi-vendor marketplace just like Amazon, Etsy, Tripadvisor and more.
[AdTribes Product Feed Pro](https://wordpress.org/plugins/woo-product-feed-pro/) – #1 plugin for generating WooCommerce product feeds for all your marketing channels.
...
* Feature: Implement unit pricing for simple and variable products
